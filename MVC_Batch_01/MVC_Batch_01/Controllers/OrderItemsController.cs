...
namespace MVC_Batch_01.Controllers
{
    public class OrderItemsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OrderItemID,OrderQty,ProductId,OrderId")] OrderItem orderItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderItemID,OrderQty,ProductId,OrderId")] OrderItem orderItem)
        {
